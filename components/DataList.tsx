...
import { View, FlatList, ActivityIndicator, StyleSheet, TouchableOpacity, ListRenderItem } from 'react-native';
...
export default function DataList({
  ...
  const { data, loading, error, refresh } = useCollection(collectionName, realtime);
          ...
          <View style={styles.itemDetails}>
            {item.quantity !== undefined && (
              <View style={styles.detailBadge}>
                <Ionicons name="cube-outline" size={14} color="#0066cc" />
                <ThemedText style={styles.detailText}>Cant: {item.quantity}</ThemedText>
              </View>
            )}
